...
class Match(object):
    ...
    def __init__(self, path, handler, priority, segments):
        self._path = path
    ...
    def descend(self):
        ...
        try:
            ...
            if parent == path.ends_with_slash:
                ...
                path, handler, priority = children
                match = Match(path, handler, priority, matched_segments)
                return match, []
...
class Routes(collections.MutableMapping):
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            _, handler, _ = branch[path.ends_with_slash]
        except KeyError:
            raise RouteKeyError()
        return handler
    ...
    def __setitem__(self, key, value):
        ...
        branch[path.ends_with_slash] = (path, handler, self._current_priority)
        caching.sparsify_dict(branch)
